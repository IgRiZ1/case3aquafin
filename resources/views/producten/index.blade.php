...
<head>
    ...
    <style>
        ...
        .product-badge {
            ...
            padding: 4px 12px; font-size: 1rem; font-weight: 500;
            display: inline-block; margin-top: 16px; margin-bottom: 10px; text-align: center;
        }
        .product-img {
            width: 180px;
            height: 180px;
        ...
        .row-eq-spacing { row-gap: 2.2rem; column-gap: 0.3rem; }
        .footer-bg {
