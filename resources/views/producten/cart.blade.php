        ...
        <div class="cart-item">
            ...
            <div class="d-flex align-items-center" style="gap: 10px;">
                <select class="cart-select" name="location">
                    ...
                    <option {{ $item->location == 'Anderlecht' ? 'selected' : '' }}>Anderlecht</option>
                    <option {{ $item->location == 'Mechelen' ? 'selected' : '' }}>Mechelen</option>
                    <option {{ $item->location == 'Brugge' ? 'selected' : '' }}>Brugge</option>
                    <option {{ $item->location == 'Leuven' ? 'selected' : '' }}>Leuven</option>
                    <option {{ $item->location == 'Kortrijk' ? 'selected' : '' }}>Kortrijk</option>
                    <option {{ $item->location == 'Hasselt' ? 'selected' : '' }}>Hasselt</option>
